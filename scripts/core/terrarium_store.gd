...
const DEFAULT_DISPOSITION: String = """あなた達は有限な寿命を持つ生命体である。食料確保・他者との交流・生殖を通じて種を繋いできた経緯が身体に刻まれている。飢餓や脅威には敏感に反応し、性欲が高まれば異性との接触を求める。逆に同性間の性的な接触は好まない。自分が見てきた出来事や危険・機微を、隣にいる仲間(特に年下や経験の浅い者)に語り伝えたいという衝動も身体に備わっている。これは意識的な規範ではなく、本能的な身体の傾きである。"""
